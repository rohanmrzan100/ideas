...
export default function ProductInformation({ product }: { product: Product }) {
  // 1. Determine unique options from product_variants
              ...
              {uniqueColors.map((color) => (
                <button
                  ...
                  onClick={() => {
                    ...
                    const variantImg = product.product_variants.find(
                      (v) => v.color === color,
                    )?.image;
                    if (variantImg) {
                      // Logic to find index of this image in main productImages array could go here
                    }
                  }}
