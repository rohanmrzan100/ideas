...
export default function SignInPage() {
  ...
  return (
    <div className="min-h-screen w-full flex bg-white font-sans selection:bg-yankeesblue selection:text-white">
      {/* --- LEFT SIDE: Form Section --- */}

      <div className="hidden lg:flex flex-col justify-center items-center w-[50%] xl:w-[50%] bg-yankeesblue relative overflow-hidden">
        <div className="absolute top-8 left-8 lg:top-12 lg:left-12 flex items-center gap-2.5">
          <div className="bg-[#C18F59] text-platinum p-2 rounded-lg">
            <Store size={20} strokeWidth={2.5} />
          </div>
          <span className="font-bold text-xl tracking-tight text-platinum">InstaShop</span>
        </div>
        {/* Background Effects */}
          ...
          >
            <div className="flex justify-between items-center mb-4">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-tealgreen flex items-center justify-center text-platinum">
                  <TrendingUp size={20} />
                </div>
                <div>
                  <p className="text-xs text-platinum font-medium">Monthly Revenue</p>
                  <p className="text-platinum font-bold text-lg">Rs. 245,000</p>
                </div>
              </div>
              <span className="text-platinum text-xs font-bold bg-tealgreen px-2 py-1 rounded">
                +12.5%
              </span>
            </div>
            <div className="h-2 bg-white/10 rounded-full overflow-hidden">
              <div className="h-full bg-[#9CAF88] w-[70%]" />
            </div>
          </motion.div>

          <h2 className="text-4xl font-bold text-platinum mb-6 leading-tight">
            Manage your store <br />
            <span className="text-platinum">from anywhere.</span>
          </h2>
          <p className="text-platinum text-lg leading-relaxed mb-8">
            Stay on top of your orders, manage inventory in real-time, and analyze your sales growth
            with our intuitive dashboard.
          </p>

          <div className="flex items-center justify-center gap-4 text-sm text-platinum">
            <span className="flex items-center gap-2">
              <div className="w-2 h-2 rounded-full bg-tealgreen" /> System Operational
            </span>
            <span>•</span>
            <span>v1.4.0</span>
          </div>
      ...
      <div className="bg-platinum w-full lg:w-[55%] xl:w-[50%] flex flex-col lg:justify-center items-center justify-start px-6 lg:py-12 py-32 lg:px-20 xl:px-32 relative">
        {/* Mobile Header (Logo) */}
        ...
        <div className="w-full max-w-md mt-12 lg:mt-0 ">
          ...
          >
            <div className="mb-10">
              <h1 className="text-3xl lg:text-4xl font-bold text-yankeesblue mb-3 tracking-tight">
                Welcome back
              </h1>
              <p className="text-yankeesblue text-lg">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="space-y-1.5">
                <label className="text-sm font-semibold text-yankeesblue">Phone Number</label>
              ...
              <div className="space-y-1.5">
                <div className="flex justify-between items-center">
                  <label
                    className="text-sm font-semibold text-yankeesblue
                  "
                  >
                    Password
                  </label>
              ...
              <Button
                ...
                className="w-full h-12 rounded-xl bg-yankeesblue hover:bg-[#1E293B] text-platinum text-base font-bold shadow-lg shadow-slate-900/20 transition-all active:scale-[0.98]"
              >
                {isSubmitting ? (
